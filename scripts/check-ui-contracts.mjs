...
assert(inline.includes("function selfServiceBench(owned)") && inline.includes("${technicians?\"\":selfServiceBench(owned)}") && css.includes(".self-service-bench{"), "The Mine floor is missing the self-service bench panel or its styling");
