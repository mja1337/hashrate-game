...
function enhanceMine(){
  ...
  const body=section==="floor"?tabCommandVisual("mine")+miningFloorVisual()
    ...
    :incomingFleetVisual();
  grid.insertAdjacentHTML("afterbegin",banner+mineSectionNav()+metrics+body);
  ...
  if(section==="floor"&&state.floorView==="3d"&&typeof mountFloor3d==="function")mountFloor3d();
}
